      ...
      <AccordionTrigger className="p-2  border-2">
        ...
        <div className="flex flex-row gap-2  w-full justify-end pr-8">
          ...
          <Button
            ...
            className="p-2 bg-transparent invert"
          >
      ...
      <AccordionContent>
        ...
        <div className="md:hidden">
          <Tabs defaultValue="text" className="w-full">
            <TabsList className="grid w-full grid-cols-2 gap-1 h-15 m-0">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    variant={
                      textSet.textAlign === "center" ? "default" : "secondary"
                    }
                    onClick={() =>
                      handleAttributeChange(textSet.id, "textAlign", "center")
                    }
                  >
                    <AlignCenter className="h-4 w-4 mr-2" />
                    Center
                  ...
                  <Button
                    variant={
                      textSet.textAlign === "right" ? "default" : "secondary"
                    }
                    onClick={() =>
                      handleAttributeChange(textSet.id, "textAlign", "right")
                    }
                  >
                    <AlignRight className="h-4 w-4 mr-2" />
                    Right
